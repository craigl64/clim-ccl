...
(defclass basic-port (port)
    ((server-path :reader port-server-path)
     ...
     (mapping-table :initform
		    #+(or aclpc acl86win32 Clozure) (make-hash-table :test #'equal)
		    #-(or aclpc acl86win32 Clozure) (mapping-table-initform))
     ;; one entry cache
     (mapping-cache :initform
		    #+(or aclpc acl86win32 Clozure) (cons nil nil)
		    #-(or aclpc acl86win32 Clozure) (mapping-cache-initform))
#+(or aclpc acl86win32 Clozure)
